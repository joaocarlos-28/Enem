  ...
  "parecer_geral": "<parecer completo e encorajador de 3-4 frases>"
            ...
            try:
                ...
                <div class="parecer-card">
                    <div class="parecer-title">📋 Parecer Geral do Corretor</div>
                    <div class="parecer-text">{resultado.get("parecer_geral", "")}</div>
                </div>
                """, unsafe_allow_html=True)
...
st.markdown("""
<div class="footer">
    CorrigeAí &nbsp;·&nbsp; Powered by Groq AI &nbsp;·&nbsp; Apenas para fins educacionais<br>
    <span style="font-size:0.75rem; opacity:0.6">Esta ferramenta é um apoio ao estudo e não substitui a correção oficial do ENEM</span>
</div>
""", unsafe_allow_html=True)
